...
# Open aedt file
oDesktop.OpenProject("C:/script9/ML_aedt/ML9.aedt")
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("L Table 1", "C:/script9/ML_data/Data1 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "C:/script9/ML_data/Data2 $VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("L Table 1", "C:/script9/ML_data/Data3 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "C:/script9/ML_data/Data4 $VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("L Table 1", "C:/script9/ML_data/Data5 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "C:/script9/ML_data/Data6 $VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("L Table 1", "C:/script9/ML_data/Data7 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Calculator Expressions Table 1", "C:/script9/ML_data/Data8 $VERSION_IDX_STR.csv", False)
