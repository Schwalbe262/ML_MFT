...
REFERENCE_SCRIPT_FILE_NAME = f'C:\\script15\\run_ansys_ref.py'
...
def run_simul(version_idx_str):
    ...
    os.mkdir(f'C:\script15\ML\SIMUL_{version_idx_str}')

    #2 Make Variable info file
    with open(f'C:\script15\ML\SIMUL_{version_idx_str}\info.yaml', "w") as info_file:
    ...
    #Save file
    with open(f'C:\\script15\\ML\\SIMUL_{version_idx_str}\\run_ansys_{version_idx_str}.py',"w") as f :
    ...
    with open(f'C:\\script15\\ML\\SIMUL_{version_idx_str}\\run_bat_{version_idx_str}.bat',"w") as f :
        f.write(f'"C:\\Program Files\\AnsysEM\\AnsysEM21.1\\Win64\\ansysedt.exe" -iconic -runscriptandexit "C:\\script15\\ML\\SIMUL_{version_idx_str}\\run_ansys_{version_idx_str}.py"')

    workingDir = f'C:\script15\ML\SIMUL_{version_idx_str}'
    executeFile = f'C:\script15\ML\SIMUL_{version_idx_str}\\run_bat_{version_idx_str}.bat'
    os.chdir(workingDir)
    os.system(executeFile)

    with open(f'C:\script15\ML_data\Data1 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_1 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data2 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_1 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data3 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_2 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data4 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_2 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data5 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_3 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data6 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_3 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data7 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_4 in rdr:
            a = 1
    with open(f'C:\script15\ML_data\Data8 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_4 in rdr:
            a = 1

    with open(f'C:\script15\ML_data\Data.csv',"a", encoding='utf-8', newline='') as f :
...
for i in range(1, 10000): 
    ...
    try :
        try:
            os.remove(f'C:\script15\ML_aedt\ML15.aedt.lock')
        except:
            time.sleep(1)
        shutil.copy(f'C:\script15\ML_aedt\ML_ref.aedt',f'C:\script15\ML_aedt\ML15.aedt')
        time.sleep(1)
        run_simul(i)
        time.sleep(1)
        if os.path.isfile(f'C:\script15\ML_aedt\ML15.aedt') :
            os.remove(f'C:\script15\ML_aedt\ML15.aedt')
        time.sleep(1)	
        rmdir(f'C:\script15\ML_aedt\ML15.aedtresults')
        try:
            os.remove(f'C:\script15\ML_aedt\ML15.aedt.lock')
        except:
            time.sleep(1)
