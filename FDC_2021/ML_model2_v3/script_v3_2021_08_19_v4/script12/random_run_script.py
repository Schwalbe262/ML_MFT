...
REFERENCE_SCRIPT_FILE_NAME = f'C:\\script12\\run_ansys_ref.py'
...
def run_simul(version_idx_str):
    ...
    N1 = random.randrange(3,12)*2
    N2 = random.randrange(3,12)*2
    N = max(N1,N2)
    NX1 = int(N1/2)
    NY1 = int(NX1+1)
    NX2 = int(N2/2)
    ...
    freq = random.randrange(10,60)*1e+3
    d1 = random.randrange(50,1000) * 1e-2
    d2 = random.randrange(50,1000) * 1e-2
    move_tx = d1 + random.randrange(1,50) * 1e-1
    move_rx = d2 + random.randrange(1,50) * 1e-1
    l1 = random.randrange(l1_min,l1_max)
    ...
    airx = w1/2+space4+30
    if N1==N :
        I2 = random.randrange(10,2000)*1e-1
        I1 = N2/N1*I2 * random.randrange(80,120) * 1e-2
    elif N2==N :
        I1 = random.randrange(10,2000)*1e-1
        I2 = N1/N2*I1 * random.randrange(80,120) * 1e-2

    X2per = random.randrange(2000,5000)
    X2freq = random.randrange(10,60)*1e+3
    X2d1 = random.randrange(50,1000) * 1e-2
    X2d2 = random.randrange(50,1000) * 1e-2
    X2move_tx = X2d1 + random.randrange(1,50) * 1e-1
    X2move_rx = X2d2 + random.randrange(1,50) * 1e-1
    X2l1 = random.randrange(l1_min,l1_max)
    ...
    if N1==N :
        X2I2 = random.randrange(10,2000)*1e-1
        X2I1 = N2/N1*X2I2 * random.randrange(80,120) * 1e-2
    elif N2==N :
        X2I1 = random.randrange(10,2000)*1e-1
        X2I2 = N1/N2*X2I1 * random.randrange(80,120) * 1e-2



    X3per = random.randrange(2000,5000)
    X3freq = random.randrange(10,60)*1e+3
    X3d1 = random.randrange(50,1000) * 1e-2
    X3d2 = random.randrange(50,1000) * 1e-2
    X3move_tx = X3d1 + random.randrange(1,50) * 1e-1
    X3move_rx = X3d2 + random.randrange(1,50) * 1e-1
    X3l1 = random.randrange(l1_min,l1_max)
    ...
    if N1==N :
        X3I2 = random.randrange(10,2000)*1e-1
        X3I1 = N2/N1*X3I2 * random.randrange(80,120) * 1e-2
    elif N2==N :
        X3I1 = random.randrange(10,2000)*1e-1
        X3I2 = N1/N2*X3I1 * random.randrange(80,120) * 1e-2



    X4per = random.randrange(2000,5000)
    X4freq = random.randrange(10,60)*1e+3
    X4d1 = random.randrange(50,1000) * 1e-2
    X4d2 = random.randrange(50,1000) * 1e-2
    X4move_tx = X4d1 + random.randrange(1,50) * 1e-1
    X4move_rx = X4d2 + random.randrange(1,50) * 1e-1
    X4l1 = random.randrange(l1_min,l1_max)
    ...
    if N1==N :
        X4I2 = random.randrange(10,2000)*1e-1
        X4I1 = N2/N1*X4I2 * random.randrange(80,120) * 1e-2
    elif N2==N :
        X4I1 = random.randrange(10,2000)*1e-1
        X4I2 = N1/N2*X4I1 * random.randrange(80,120) * 1e-2
    ...
    os.mkdir(f'C:\script12\ML\SIMUL_{version_idx_str}')

    #2 Make Variable info file
    with open(f'C:\script12\ML\SIMUL_{version_idx_str}\info.yaml', "w") as info_file:
    ...
    #Save file
    with open(f'C:\\script12\\ML\\SIMUL_{version_idx_str}\\run_ansys_{version_idx_str}.py',"w") as f :
    ...
    with open(f'C:\\script12\\ML\\SIMUL_{version_idx_str}\\run_bat_{version_idx_str}.bat',"w") as f :
        f.write(f'"C:\\Program Files\\AnsysEM\\AnsysEM21.1\\Win64\\ansysedt.exe" -iconic -runscriptandexit "C:\\script12\\ML\\SIMUL_{version_idx_str}\\run_ansys_{version_idx_str}.py"')

    workingDir = f'C:\script12\ML\SIMUL_{version_idx_str}'
    executeFile = f'C:\script12\ML\SIMUL_{version_idx_str}\\run_bat_{version_idx_str}.bat'
    os.chdir(workingDir)
    os.system(executeFile)

    with open(f'C:\script12\ML_data\Data1 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_1 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data2 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_1 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data3 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_2 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data4 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_2 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data5 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_3 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data6 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_3 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data7 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line1_4 in rdr:
            a = 1
    with open(f'C:\script12\ML_data\Data8 {version_idx_str}.csv',"r") as f :
        rdr = csv.reader(f)
        for line2_4 in rdr:
            a = 1

    with open(f'C:\script12\ML_data\Data.csv',"a", encoding='utf-8', newline='') as f :

        tmp = np.concatenate((N1, N2, d1, d2, freq, move_tx, move_rx, offset_tx, offset_rx, per, space1, space2, space3, space4, space5, space6, l1, l2, h1, w1, I1, I2, line1_1[1], line1_1[2], line1_1[3], line1_1[4], line1_1[5], line1_1[6], line1_1[7], line1_1[8], line1_1[9], line1_1[10], line1_1[11], line1_1[12], line1_1[13], line1_1[14], line1_1[15], line2_1[2], line2_1[3]), axis=None)
        wr = csv.writer(f)
        wr.writerow(tmp)

        tmp = np.concatenate((N1, N2, X2d1, X2d2, X2freq, X2move_tx, X2move_rx, X2offset_tx, X2offset_rx, X2per, X2space1, X2space2, X2space3, X2space4, X2space5, X2space6, X2l1, X2l2, X2h1, X2w1, X2I1, X2I2, line1_2[1], line1_2[2], line1_2[3], line1_2[4], line1_2[5], line1_2[6], line1_2[7], line1_2[8], line1_2[9], line1_2[10], line1_2[11], line1_2[12], line1_2[13], line1_2[14], line1_2[15], line2_2[2], line2_2[3]), axis=None)
        wr = csv.writer(f)
        wr.writerow(tmp)

        tmp = np.concatenate((N1, N2, X3d1, X3d2, X3freq, X3move_tx, X3move_rx, X3offset_tx, X3offset_rx, X3per, X3space1, X3space2, X3space3, X3space4, X3space5, X3space6, X3l1, X3l2, X3h1, X3w1, X3I1, X3I2, line1_3[1], line1_3[2], line1_3[3], line1_3[4], line1_3[5], line1_3[6], line1_3[7], line1_3[8], line1_3[9], line1_3[10], line1_3[11], line1_3[12], line1_3[13], line1_3[14], line1_3[15], line2_3[2], line2_3[3]), axis=None)
        wr = csv.writer(f)
        wr.writerow(tmp)

        tmp = np.concatenate((N1, N2, X4d1, X4d2, X4freq, X4move_tx, X4move_rx, X4offset_tx, X4offset_rx, X4per, X4space1, X4space2, X4space3, X4space4, X4space5, X4space6, X4l1, X4l2, X4h1, X4w1, X4I1, X4I2, line1_4[1], line1_4[2], line1_4[3], line1_4[4], line1_4[5], line1_4[6], line1_4[7], line1_4[8], line1_4[9], line1_4[10], line1_4[11], line1_4[12], line1_4[13], line1_4[14], line1_4[15], line2_4[2], line2_4[3]), axis=None)
        wr = csv.writer(f)
        wr.writerow(tmp)
...
for i in range(1, 10000): 
    ...
    try :
        try:
            os.remove(f'C:\script12\ML_aedt\ML12.aedt.lock')
        except:
            time.sleep(1)
        if os.path.isfile(f'C:\script12\ML_aedt\ML12.aedt') :
            os.remove(f'C:\script12\ML_aedt\ML12.aedt')
        time.sleep(1)	

        shutil.copy(f'C:\script12\ML_aedt\ML_ref.aedt',f'C:\script12\ML_aedt\ML12.aedt')
        time.sleep(1)
        ...
        rmdir(f'C:\script12\ML_aedt\ML12.aedtresults')
        try:
            os.remove(f'C:\script12\ML_aedt\ML12.aedt.lock')
        except:
            time.sleep(1)
