...
# get report
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Parameter", "C:/script12/ML_data/Data1 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("loss", "C:/script12/ML_data/Data2 $VERSION_IDX_STR.csv", False)
...
# get report
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Parameter", "C:/script12/ML_data/Data3 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("loss", "C:/script12/ML_data/Data4 $VERSION_IDX_STR.csv", False)
...
# get report
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Parameter", "C:/script12/ML_data/Data5 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("loss", "C:/script12/ML_data/Data6 $VERSION_IDX_STR.csv", False)
...
# get report
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Parameter", "C:/script12/ML_data/Data7 $VERSION_IDX_STR.csv", False)
oModule.ExportToFile("loss", "C:/script12/ML_data/Data8 $VERSION_IDX_STR.csv", False)