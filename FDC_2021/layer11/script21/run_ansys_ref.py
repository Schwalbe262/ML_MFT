...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer11/script21/ML_aedt/ML21.aedt")
...
for i in range(N2-3) : 
    ...
    z_vector = "-" + str(i+2) + "*(coil_width[0]+move_z[1])"
...
oEditor.Move(
        ...
        [
            ...
            "TranslateVectorX:="	, "0mm",
            "TranslateVectorY:="	, "0mm",
            "TranslateVectorZ:="	, "-1*(coil_width[0]+move_z[1])"
        ])
...
name_temp = "Rx" + str(N2)
move_temp = "-" + str(N2-1) + "*(coil_width[0]+move_z[1])"
...
oEditor.Move(
        ...
        [
            ...
            "TranslateVectorX:="	, "0mm",
            "TranslateVectorY:="	, "0mm",
            "TranslateVectorZ:="	, "offset_z[1]+(N2/2)*coil_width[0]+(N2/2)*move_z[1]"
        ])
...
oEditor.CreateRegularPolygon(
	[
		...
		"IsCovered:="		, True,
		"XCenter:="		, "air[0]/2",
		"YCenter:="		, "-l1-coil_width[0]-coil_width[1]/2-space[1]-space[3]",
		"ZCenter:="		, "l1+h1/2+5mm",
		"XStart:="		, "air[0]/2",
		"YStart:="		, "-l1-coil_width[0]-coil_width[1]-space[1]-space[3]",
		"ZStart:="		, "l1+h1/2+5mm",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "X"
	], 
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer11/script21/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer11/script21/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer11/script21/ML_data/loss$VERSION_IDX_STR.csv", False)
