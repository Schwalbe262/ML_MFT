...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer12/script27/ML_aedt/ML27.aedt")
	...
	[
		...
		[
			...
			[
				...
				"X:="			, "w1/2+coil_width[0]/2+space[0]",
				"Y:="			, "-l1-coil_width[0]/2-space[1]",
				"Z:="			, "-l1-h1/2-offset_z[0]-(N1/2)*coil_width[0]-(N1/2)*move_z[0]+11*(coil_width[0]+move_z[0])"
			]	
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer12/script27/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer12/script27/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer12/script27/ML_data/loss$VERSION_IDX_STR.csv", False)
