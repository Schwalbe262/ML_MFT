...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer22/script29/ML_aedt/ML29.aedt")
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "-w1/2-3/2*5/2*coil_width[1]-space[0]-space[2]-space[4]-space[5]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[2]-space[4]-space[5]",
				"Z:="			, "0/2*(coil_width[1]+move_z[1])"
			],
			[
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer22/script29/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer22/script29/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer22/script29/ML_data/loss$VERSION_IDX_STR.csv", False)
