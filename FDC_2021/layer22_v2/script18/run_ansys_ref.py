...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer22_v2/script18/ML_aedt/ML18.aedt")
	...
	[
		...
		[
			...
			[
				...
				"Y:="			, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[2]-space[4]",
				"Z:="			, "air[2]/2-5mm"
			],
			[
				"NAME:PLPoint",
	...
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[2]-space[4]-space[5]",
				"Z:="			, "-2/2*(coil_width[1]+move_z[1])"
			],
			[
				"NAME:PLPoint",
...
oEditor.CreateRegularPolygon(
	[
		...
		"YCenter:="		, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[2]-space[4]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+2*coil_width[0]+2/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YStart:="		, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[2]-space[4]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oEditor.CreateRegularPolygon(
	[
		...
		"IsCovered:="		, True,
		"XCenter:="		, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YCenter:="		, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[2]-space[4]-space[5]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+2*coil_width[0]+2/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YStart:="		, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[2]-space[4]-space[5]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script18/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script18/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script18/ML_data/loss$VERSION_IDX_STR.csv", False)
