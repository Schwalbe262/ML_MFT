...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer22_v2/script19/ML_aedt/ML19.aedt")
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script19/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script19/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer22_v2/script19/ML_data/loss$VERSION_IDX_STR.csv", False)
