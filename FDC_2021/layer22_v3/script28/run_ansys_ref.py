...
oDesktop.OpenProject("Y:/git/ML_MFT/FDC_2021/layer22_v3/script28/ML_aedt/ML28.aedt")
	...
	[
		...
		[
			...
			[
				...
				"X:="			, "w1/2+coil_width[0]/2+space[0]",
				"Y:="			, "-l1-coil_width[0]/2-space[1]",
				"Z:="			, "air[2]/2-5mm-offset_z[0]-(N1/4)*(coil_width[0]+move_z[0])"
			],
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+coil_width[0]/2+space[0]",
	...
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+coil_width[0]/2+space[0]",
				"Y:="			, "-l1-3/2*coil_width[0]-space[1]-space[4]",
				"Z:="			, "-2/2*(coil_width[0]+move_z[0])"
			],
			[
				"NAME:PLPoint",
...
name_temp = "Tx" + str(NX1+1)
move_temp = "-" + str(NX1) + "*(coil_width[0]+move_z[0])"
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+coil_width[0]/2+space[1]/2",
				"Y:="			, "-l1-3/2*coil_width[0]-space[1]-space[4]",
				"Z:="			, "0/2*(coil_width[0]+move_z[0])"
			],
			[
			...
			[
				"NAME:PLPoint",
				"X:="			, "-w1/2-3/2*coil_width[0]-space[0]-space[4]",
				"Y:="			, "-l1-3/2*coil_width[0]-space[1]-space[4]",
				"Z:="			, "0/2*(coil_width[0]+move_z[0])"
			],
			[
...
name_temp = "Tx" + str(N1)
move_temp = "-1*(coil_width[0]+move_z[0])"	
		...
		[
			...
			[
				...
				[
					...
					"X:="			, "w1/2+coil_width[0]/2+space[0]",
					"Y:="			, "-l1-3/2*coil_width[0]-space[1]-space[4]",
					"Z:="			, "air[2]/2+(coil_width[0]+move_z[0])-5mm-offset_z[0]-(N1/4)*(coil_width[0]+move_z[0])"
				]
...
oEditor.Move(
        ...
        [
            ...
            "TranslateVectorX:="	, "0mm",
            "TranslateVectorY:="	, "0mm",
            "TranslateVectorZ:="	, "offset_z[0]+(N1/4)*coil_width[0]+(N1/4)*move_z[0]"
        ])
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
				"Y:="			, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[3]-space[4]",
				"Z:="			, "air[2]/2-5mm"
			],
			[
				"NAME:PLPoint",
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+1/2*coil_width[1]",
				"Y:="			, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[3]-space[4]",
				"Z:="			, "-0/2*(coil_width[1]+move_z[1])"
			],
			[
	...
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
				"Z:="			, "-2/2*(coil_width[1]+move_z[1])"
			],
			[
				"NAME:PLPoint",
...
oEditor.CreatePolyline(
	[
		...
		[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[1]/2+space[2]/2+space[4]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
				"Z:="			, "0/2*(coil_width[1]+move_z[1])"
			],
			[
			...
			[
				"NAME:PLPoint",
				"X:="			, "-w1/2-2*coil_width[0]-3/2*coil_width[1]-space[0]-space[2]-space[4]-space[5]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
				"Z:="			, "0/2*(coil_width[1]+move_z[1])"
			],
			[
			...
			[
				"NAME:PLPoint",
				"X:="			, "w1/2+2*coil_width[0]+3/2*coil_width[1]",
				"Y:="			, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
				"Z:="			, "2/2*(coil_width[1]+move_z[1])"
			]
...
oEditor.CreateRegularPolygon(
	[
		...
		"IsCovered:="		, True,
		"XCenter:="		, "w1/2+coil_width[0]/2+space[0]",
		"YCenter:="		, "-l1-coil_width[0]/2-space[1]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+coil_width[0]+space[0]",
		"YStart:="		, "-l1-coil_width[0]/2-space[1]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oEditor.CreateRegularPolygon(
	[
		...
		"IsCovered:="		, True,
		"XCenter:="		, "w1/2+coil_width[0]/2+space[0]",
		"YCenter:="		, "-l1-3/2*coil_width[0]-space[1]-space[4]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+coil_width[0]+space[0]",
		"YStart:="		, "-l1-3/2*coil_width[0]-space[1]-space[4]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oEditor.CreateRegularPolygon(
	[
		"NAME:RegularPolygonParameters",
		"IsCovered:="		, True,
		"XCenter:="		, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YCenter:="		, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[3]-space[4]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+2*coil_width[0]+2/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YStart:="		, "-l1-2*coil_width[0]-1/2*coil_width[1]-space[1]-space[3]-space[4]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oEditor.CreateRegularPolygon(
	[
		...
		"IsCovered:="		, True,
		"XCenter:="		, "w1/2+2*coil_width[0]+1/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YCenter:="		, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
		"ZCenter:="		, "air[2]/2",
		"XStart:="		, "w1/2+2*coil_width[0]+2/2*coil_width[1]+space[0]+space[2]+space[4]",
		"YStart:="		, "-l1-2*coil_width[0]-3/2*coil_width[1]-space[1]-space[3]-space[4]-space[5]",
		"ZStart:="		, "air[2]/2",
		"NumSides:="		, "Num",
		"WhichAxis:="		, "Z"
	], 
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v3/script28/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/FDC_2021/layer22_v3/script28/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/FDC_2021/layer22_v3/script28/ML_data/loss$VERSION_IDX_STR.csv", False)
