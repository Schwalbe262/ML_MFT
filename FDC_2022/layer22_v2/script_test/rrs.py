...
for i in range(0, 10000): 
    ...
    try :
        try:
            os.remove(f'.\ML_aedt\ML_test.aedt.lock')
        except:
            time.sleep(1)
        if os.path.isfile(f'.\ML_aedt\ML_test.aedt') :
            os.remove(f'.\ML_aedt\ML_test.aedt')
        time.sleep(1)	

        shutil.copy(f'.\ML_aedt\ML_ref.aedt',f'.\ML_aedt\ML_test.aedt')
        time.sleep(1)
        ...
        shutil.rmtree(f'.\ML_aedt\ML_test.aedtresults')
        try:
            os.remove(f'.\ML_aedt\ML_test.aedt.lock')
        except:
            time.sleep(1)
