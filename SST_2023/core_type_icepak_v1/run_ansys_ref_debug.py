...
# Make project
oProject = oDesktop.SetActiveProject("thermal_automation_test")
oProject.InsertDesign("Icepak", "Icepak_ML_v0", "TemperatureAndFlow", "")

oDesign = oProject.SetActiveDesign("Icepak_ML_v0")
...
oDefinitionManager.AddMaterial(
	[
		...
		"permeability:="	, "1000",
		"conductivity:="	, "0.01",
		"thermal_conductivity:=", "80", # $core_thermal_coeff
		"mass_density:="	, "4600",
		"specific_heat:="	, "750",
...
oDefinitionManager.AddMaterial(
	[
		...
		"thermal_conductivity:=", "0.2", # $epoxy_thermal_coeff
		"mass_density:="	, "1120",
		"specific_heat:="	, "1400",
		[
...
oDefinitionManager.AddMaterial(
	[
		...
		"thermal_conductivity:=", "0.2", # $bobin_thermal_coeff
		"mass_density:="	, "1120",
		"specific_heat:="	, "1400",
		[
			"NAME:thermal_material_type",
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[25, 25, 10, 10] mm" # $space1, $space2, $space3, $space4
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[6, 8] mm" # $coil_width1, $coil_width2
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[0, 0] mm" # $offset_z1, $offset_z2
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[15, 15] mm" # $epoxy_x, $epoxy_y
				]
			]
		]
	])
		...
		[
			...
			[
				...
				[
					...
					"PropType:="		, "VariableProp",
					"UserDef:="		, True,
					"Value:="		, "[50, 50, 20, 15, 15, 15] mm" # $cold_x1, $cold_y1, $cold_z1, $cold_x2, $cold_y2, $cold_z2
				]
			]
		]
	])
...
oEditor.CreateBox(
	...
	[
		...
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"ferrite_v1\"", # %ferrite_v$VERSION_IDX_STR
...
oEditor.CreateBox(
	...
	[
		...
		"PartCoordinateSystem:=", "Global",
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"epoxy_v1\"", # %epoxy_v$VERSION_IDX_STR
...
oEditor.CreateBox(
	...
	[
		...
		"PartCoordinateSystem:=", "Global",
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"bobin_epoxy_v1\"", # %epoxy_v$VERSION_IDX_STR
		"SurfaceMaterialValue:=", "\"steel-oxidised-surface\"",
		"SolveInside:="		, True,
		"IsMaterialEditable:="	, True,
		"UseMaterialAppearance:=", False,
...
oEditor.CreateBox(
	...
	[
		...
		"PartCoordinateSystem:=", "Global",
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"aluminum\"", # %epoxy_v$VERSION_IDX_STR
		"SurfaceMaterialValue:=", "\"steel-oxidised-surface\"",
		"SolveInside:="		, True,
		"IsMaterialEditable:="	, True,
		"UseMaterialAppearance:=", False,
...
oModule.ExportToFile("Calculator Expressions Table 1", "C:/Users/NEC_v/Desktop/Calculator Expressions Table 1.csv", False)





oDefinitionManager.RemoveMaterial("ferrite_v1", True, "", "Project")
oDefinitionManager.RemoveMaterial("epoxy_v1", True, "", "Project")



oProject.DeleteDesign("Icepak_ML_v0")