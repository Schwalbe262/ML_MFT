...
def run_simul(version_idx_str):
    ...
    final_data = np.loadtxt(f'Z:\\Autosimul_data\\MFT\\SST_2023\\core_type_icepak_v1\\{COMPUTER_NAME}\\script3\\temp_data.csv', delimiter=",")
    new_data1 = np.vstack((final_data, temp))
    np.savetxt(f'Z:\\Autosimul_data\\MFT\\SST_2023\\core_type_icepak_v1\\{COMPUTER_NAME}\\script3\\temp_data.csv',new_data1,delimiter=",")
