...
def run_simul(version_idx_str):
    ...
    data1 = np.loadtxt(f'Z:\Autosimul_data\MFT\core_type_solid\{COMPUTER_NAME}\script10\inductance.csv', delimiter=",")
    new_data1 = np.vstack((data1, temp1))
    np.savetxt(f'Z:\Autosimul_data\MFT\core_type_solid\{COMPUTER_NAME}\script10\inductance.csv',new_data1,delimiter=",")

    data2 = np.loadtxt(f'Z:\Autosimul_data\MFT\core_type_solid\{COMPUTER_NAME}\script10\coupling.csv', delimiter=",")
    new_data2 = np.vstack((data2, temp2))
    np.savetxt(f'Z:\Autosimul_data\MFT\core_type_solid\{COMPUTER_NAME}\script10\coupling.csv',new_data2,delimiter=",")
