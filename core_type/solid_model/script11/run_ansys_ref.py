...
oDesktop.OpenProject("Y:/git/ML_MFT/core_type/solid_model/script11/ML_aedt/ML11.aedt")
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-(w1+150mm)/2",
		"YPosition:="		, "-(2*l1+l2+150mm)/2",
		"ZPosition:="		, "-(2*l1+h1+100mm)/2",
		"XSize:="		, "(w1+150mm)",
		"YSize:="		, "(2*l1+l2+150mm)",
		"ZSize:="		, "(2*l1+h1+100mm)"
	], 
...
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/core_type/solid_model/script11/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/core_type/solid_model/script11/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/core_type/solid_model/script11/ML_data/loss$VERSION_IDX_STR.csv", False)
