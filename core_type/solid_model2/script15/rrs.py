...
def run_simul(version_idx_str):
    ...
    data1 = np.loadtxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\magnetizing_inductance.csv', delimiter=",")
    new_data1 = np.vstack((data1, temp1))
    np.savetxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\magnetizing_inductance.csv',new_data1,delimiter=",")

    data2 = np.loadtxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\leakage_inductance.csv', delimiter=",")
    new_data2 = np.vstack((data2, temp2))
    np.savetxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\leakage_inductance.csv',new_data2,delimiter=",")

    data3 = np.loadtxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\loss.csv', delimiter=",")
    new_data3 = np.vstack((data3, temp3))
    np.savetxt(f'Z:\Autosimul_data\MFT\core_type_solid2\{COMPUTER_NAME}\script15\loss.csv',new_data3,delimiter=",")
