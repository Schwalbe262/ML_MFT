...
oDesktop.OpenProject("Y:/git/ML_MFT/shell_type/litz_model/script22/ML_aedt/ML22.aedt")
...
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/shell_type/litz_model/script22/ML_data/loss$VERSION_IDX_STR.csv", False)
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script22/ML_data/litz_Tx_loss$VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script22/ML_data/litz_Rx_loss$VERSION_IDX_STR.csv", False)
