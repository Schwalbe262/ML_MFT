...
oProject.InsertDesign("Maxwell", "Maxwell_ML_v1", "EddyCurrent", "")
...
oEditor.CreatePolyline(
	...
	[
		...
		"MaterialValue:="	, "\"copper_litz_Tx_script1_1\"",
...
oEditor.CreatePolyline(
	...
	[
		...
		"MaterialValue:="	, "\"copper_litz_Rx_script1_1\"",
...
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/core_type/litz_model/script1/ML_data/magnetizing_inductance1.csv", False)

oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/core_type/litz_model/script1/ML_data/leakage_inductance1.csv", False)

oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/core_type/litz_model/script1/ML_data/loss1.csv", False)
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/core_type/litz_model/script1/ML_data/litz_Tx_loss1.csv", False)
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/core_type/litz_model/script1/ML_data/litz_Rx_loss1.csv", False)
...
oDefinitionManager.RemoveMaterial("copper_litz_Tx_script1_1", True, "", "Project")

oDefinitionManager.RemoveMaterial("copper_litz_Rx_script1_1", True, "", "Project")

oDefinitionManager.RemoveMaterial("ferrite1", True, "", "Project")