...
# Open aedt file
#oDesktop.OpenProject("Z:/ANSYS_simulation/transformer/core_type_HFTR/HFTR_2022_05_31_solid_model/ML9.aedt")
oDesktop.OpenProject("Y:/git/ML_MFT/shell_type/litz_model/script9/ML_aedt/ML9.aedt")
...
oDefinitionManager.AddMaterial(
	[
		"NAME:copper_litz_Tx_script9_$VERSION_IDX_STR",
		"CoordinateSystemType:=", "Cartesian",
		"BulkOrSurfaceType:="	, 1,
		[
			"NAME:PhysicsTypes",
...
oDefinitionManager.AddMaterial(
	[
		"NAME:copper_litz_Rx_script9_$VERSION_IDX_STR",
		"CoordinateSystemType:=", "Cartesian",
		"BulkOrSurfaceType:="	, 1,
		[
			"NAME:PhysicsTypes",
...
oEditor.CreatePolyline(
	...
	[
		...
		"PartCoordinateSystem:=", "Global",
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"copper_litz_Tx_script9_$VERSION_IDX_STR\"",
		"SurfaceMaterialValue:=", "\"\"",
		"SolveInside:="		, True,
		"IsMaterialEditable:="	, True,
		"UseMaterialAppearance:=", False,
...
oEditor.CreatePolyline(
	...
	[
		...
		"PartCoordinateSystem:=", "Global",
		"UDMIZ:="		, "",
		"MaterialValue:="	, "\"copper_litz_Rx_script9_$VERSION_IDX_STR\"",
		"SurfaceMaterialValue:=", "\"\"",
		"SolveInside:="		, True,
		"IsMaterialEditable:="	, True,
		"UseMaterialAppearance:=", False,
...
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/shell_type/litz_model/script9/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/shell_type/litz_model/script9/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("copper loss", "Y:/git/ML_MFT/shell_type/litz_model/script9/ML_data/loss$VERSION_IDX_STR.csv", False)
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script9/ML_data/litz_Tx_loss$VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script9/ML_data/litz_Rx_loss$VERSION_IDX_STR.csv", False)



oDefinitionManager.RemoveMaterial("copper_litz_Tx_script9_$VERSION_IDX_STR", True, "", "Project")
oDefinitionManager.RemoveMaterial("copper_litz_Rx_script9_$VERSION_IDX_STR", True, "", "Project")
