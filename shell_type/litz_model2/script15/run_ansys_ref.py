...
oDesktop.OpenProject("Y:/git/ML_MFT/shell_type/litz_model2/script15/ML_aedt/ML15.aedt")
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("magnetizing inductance", "Y:/git/ML_MFT/shell_type/litz_model2/script15/ML_data/magnetizing_inductance$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("leakage inductance", "Y:/git/ML_MFT/shell_type/litz_model2/script15/ML_data/leakage_inductance$VERSION_IDX_STR.csv", False)
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model2/script15/ML_data/litz_Tx_loss$VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model2/script15/ML_data/litz_Rx_loss$VERSION_IDX_STR.csv", False)
