...
oDesktop.OpenProject("Y:/git/ML_MFT/shell_type/litz_model/script4/ML_aedt/ML4.aedt")
...
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script4/ML_data/litz_Tx_loss$VERSION_IDX_STR.csv", False)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("litz loss", "Y:/git/ML_MFT/shell_type/litz_model/script4/ML_data/litz_Rx_loss$VERSION_IDX_STR.csv", False)
